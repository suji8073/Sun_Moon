...
public class sun_exercise_intro extends AppCompatActivity {
    TextView txt, back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sun_exercies_intro);
...
//        },600);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //handler.removeCallbacksAndMessages(null);
                timerStatus=-1;
                Intent start_intent = new Intent(sun_exercise_intro.this, sun_exercise_screen.class);
                startActivity(start_intent);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                timerStatus=-1;
                Intent start_intent = new Intent(sun_exercise_intro.this, list.class);
                startActivity(start_intent);
            }
        });
